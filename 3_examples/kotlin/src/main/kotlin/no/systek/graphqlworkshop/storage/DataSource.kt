...
class DataSource {
    ...
    fun getDish(id: Long): Dish = dishes.first { it.id == id }

    fun getIngredient(id: Long): Ingredient = ingredients.first { it.id == id }

    fun addOrder(order: Order): Boolean = orders.add(order)
